const cacheName : string = "static-v2938";
...
self.addEventListener("install", (e : any) =>
	e.waitUntil(caches.open(cacheName).then(cache => cache.addAll([
		...
		"/assets/js/home.c6bad01b07cc124d70ab.js",
		"/assets/js/account.41c20e0330b77e0eb48d.js",
		"/assets/js/settings.a921ffe325ab58743871.js",
