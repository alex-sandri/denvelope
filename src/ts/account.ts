...
window.addEventListener("userready", () =>
{
    ...
    document.addEventListener("contextmenu", e =>
        (!Utilities.IsTouchDevice() && (<HTMLElement>e.target).closest(".allow-context-menu") === null) ? showContextMenu(e) : HideContextMenu());
...
const addUserContentEvents = () : void =>
{
    ...
    [...userContentElements, navigationBackButton, vault].forEach(element =>
    {
        const HandleTargetElement = (e : MouseEvent | TouchEvent) : void =>
        {
            ...
            if (((e.type === "touchmove" && isUserContentElement(targetFromPoint) && Utilities.IsSet(targetFromPoint.closest(folderSelector))) || e.type === "mouseenter") &&
